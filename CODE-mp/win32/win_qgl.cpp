...
void ( APIENTRY * qglBeginReal )(GLenum mode);
...
void ( APIENTRY * qglDrawArraysReal )(GLenum mode, GLint first, GLsizei count);
void ( APIENTRY * qglDrawBuffer )(GLenum mode);
void ( APIENTRY * qglDrawElements )(GLenum mode, GLsizei count, GLenum type, const GLvoid *indices);
void ( APIENTRY * qglDrawElementsReal )(GLenum mode, GLsizei count, GLenum type, const GLvoid *indices);
...
void (APIENTRYP qglPatchParameteri) (GLenum, GLint);
...
void ( APIENTRY * dllBeginReal )(GLenum mode);
...
void ( APIENTRY * dllDrawArraysReal )(GLenum mode, GLint first, GLsizei count);
...
void ( APIENTRY * dllDrawElementsReal )(GLenum mode, GLsizei count, GLenum type, const GLvoid *indices);
...
qboolean QGL_Init( const char *dllname )
{
	...
	qglBeginReal                 = dllBeginReal = (void (__stdcall *)(unsigned int))GPA( "glBegin" );
	...
	qglDrawArraysReal            = dllDrawArraysReal = (void (__stdcall *)(unsigned int,int,int))GPA( "glDrawArrays" );
	...
	qglDrawElementsReal          = dllDrawElementsReal = (void (__stdcall *)(unsigned int,int,unsigned int,const void *))GPA( "glDrawElements" );
