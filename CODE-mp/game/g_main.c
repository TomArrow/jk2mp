...
static cvarTable_t		gameCvarTable[] = {
	...
	// engine that supports more than the default 256 submodels. The value "3" enables both workarounds for backwards compatibility with
	// old cgame versions.
	{ &g_submodelWorkaround, "g_submodelWorkaround", "2", CVAR_ARCHIVE | CVAR_LATCH, 0, qtrue }, // I personally set it to 1 because this is jomme :) I only play demos
};
