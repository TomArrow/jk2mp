...
extern	vmCvar_t		cg_debugSuppressAnnoyingDebugs;
...
qhandle_t	trap_R_RegisterShaderNoMipHUD( const char *name );			// special version for HUD, marks shader as hud
...
void		trap_R_AddShadowLineToScene(const vec3_t p1, const vec3_t p2, float width, float a, float b);
